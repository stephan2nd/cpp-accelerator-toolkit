...
unsigned int test_ion(bool verbose)
{
	...
	Ion electron(0,0,-1);
	Ion proton(1,1,1);
	DriftTube tube("",0.4,0.2,2.0);
	DriftTube tube2("",0.4,0.2,0.5);	
	QuadrupoleMagnet qm1("DQ1",0.4,0.2,0.5,-0.5);
	QuadrupoleMagnet qm2("DQ2",0.4,0.2,0.5,0.3);	
	Trafo dt1("DT1");
	Trafo dt2("DT2");	
	DipoleMagnet dm("DM",0.4,0.2,1.0,1.0);
